...
def home():
    ...
    layout = [
        [sg.Image("img/Screenshot_1.png",size=(80,80),pad=(270,(0,0)))],
        [sg.Text("SAFELLI",font="verdana 13 bold",pad=(270,(0,10)), text_color="#000080")],
        [sg.HSep(color="#000080")],
        [sg.Col(from_config,element_justification='left', justification='left',pad=(10,(0,0)),size=(250,250)),sg.Col(layout_direita,pad=(30,(0,0)),background_color="MintCream")],
