...
def home():
    ...
    layout_direita = [
        ...
        [sg.Multiline(s=(50,10), pad=(0,(0,0)), disabled=True, key="algoritmo")],
        [sg.Text("LOG POSICAO MOUSE",pad=(20,(0,0)),text_color="#000080")],
        [sg.Multiline(s=(50,10), pad=(0,(0,0)), disabled=True,key="log",font="arial 10")],
    ...
    layout = [
        [sg.Image("img/Screenshot_1.png",size=(80,80),pad=(250,(0,0))),sg.Text("")],
